...
public class AccountResource {
    ...
    public AccountResource(UserRepository userRepository, UserService userService, RegisterService registerService, MailService mailService, PersistentTokenRepository persistentTokenRepository) {
    ...
    public Register activateRegister(@RequestParam(value = "key") String key) {
       return registerService.activeRegister(key);
    }
}
